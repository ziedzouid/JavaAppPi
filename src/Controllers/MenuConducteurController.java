...
public class MenuConducteurController implements Initializable {
    ...
    @FXML
    private AnchorPane newride;
    @FXML
    private AnchorPane postpilote;
    @FXML
    private AnchorPane patingpilote;
    @FXML
    private StackPane fabsContainer;
    @FXML
    private HBox boxMenus1;
    @FXML
    private AnchorPane eventpilote;
    @FXML
    private AnchorPane actspilote;
    @FXML
    private AnchorPane feedbackspilote;
    @FXML
    private AnchorPane profilepilot;
    @FXML
    ...
    @FXML
    private void switchToProfilepilot(MouseEvent event) {
    ...
    @FXML
    private void switchToPostpilote(MouseEvent event) {
        try {

            Parent root = FXMLLoader.load(getClass().getResource("/Views/Afficherposte.fxml"));
            Scene scene = new Scene(root);
            Stage s = (Stage) ((Node) event.getSource()).getScene().getWindow();
            s.setScene(scene);
            s.show();
    ...
    @FXML
    private void switchToactspilote(MouseEvent event) {
        try {
    ...
    @FXML
    private void switchTofeedspilote(MouseEvent event) {
        try {
    ...
    @FXML
    private void switchTonewride(MouseEvent event) {
        try {

            Parent root = FXMLLoader.load(getClass().getResource("/Views/TrajetList.fxml"));
            Scene scene = new Scene(root);
            Stage s = (Stage) ((Node) event.getSource()).getScene().getWindow();
            s.setScene(scene);
            s.show();
    ...
    @FXML
    private void switchToeventpilote(MouseEvent event) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/Views/Eventcondu.fxml"));
            Scene scene = new Scene(root);
            Stage s = (Stage) ((Node) event.getSource()).getScene().getWindow();
            s.setScene(scene);
            s.show();
    ...
    private void setUpFabs() {
        ...
        button2.setOnAction((ActionEvent event) -> {
            try {
                postpilote.getScene().getWindow().hide();
    ...
    @FXML
    private void switchToratingpilotes(MouseEvent event) throws IOException {
        /* try {
            Parent root = FXMLLoader.load(getClass().getResource("/Views/EvaluationsDuConduteurFXML.fxml"));
            Scene scene = new Scene(root);
            Stage s = (Stage) ((Node) event.getSource()).getScene().getWindow();
            s.setScene(scene);
            s.show();
         ...
         FXMLLoader loader = new FXMLLoader(getClass().getResource("/Views/EvaluationsDuConduteurFXML.fxml"));

            Parent root = loader.load();

            profilepilot.getScene().setRoot(root);
    }
}
